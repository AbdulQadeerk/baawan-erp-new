...
export const SalesPersonDetailsModal: React.FC<SalesPersonDetailsModalProps> = ({
  ...
  const [record, setRecord] = useState<SalesPersonRecord | null>(null);
            ...
            <div className="px-8 py-6">
              ...
              {!isLoading && !error && record && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <DetailItem label="First Name" value={record.first_Name || 'N/A'} />
                  <DetailItem label="Last Name" value={record.lastname || 'N/A'} />
                  <DetailItem label="Email" value={record.email_ID || 'N/A'} />
                  <DetailItem label="Mobile no." value={record.mobileNo || 'N/A'} />
                </div>
              )}
            </div>
