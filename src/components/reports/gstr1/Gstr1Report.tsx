...
const GSTR1_REPORT_OPTIONS = [
  { text: "B2B", id: 1, type: 1 },
  { text: "GSTR1 B2NS", id: 2, type: 1 },
  { text: "GST-HSN", id: 3, type: 1 },
  { text: "CDNR", id: 4, type: 2 },
  { text: "GST-HSN-RETURN", id: 5, type: 2 },
  { text: "Doc Issued", id: 6, type: 1 },
  { text: "B2NS-GST-HSN", id: 7, type: 1 },
  { text: "B2NS-GST-HSN-RETURN", id: 8, type: 2 },
];
    ...
    try {
      ...
      if (blob && blob.size > 0) {
        ...
        if (lst.length) {
          ...
          XLSX.writeFile(wb, "gstr1Report.xlsx");
        } else {
  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      if (printData?.length) {
        ...
        const optionText = GSTR1_REPORT_OPTIONS.find((o) => o.id === Number(reportOption))?.text || "";
    ...
    <div className="font-sans text-slate-700 dark:text-slate-200 pt-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800 dark:text-slate-100">GSTR1 Report</h1>
            <p className="text-xs text-slate-500 font-medium">
              Tax returns summary and invoice breakdown reports.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-5">
        <div className="flex flex-wrap items-end gap-3">
          ...
          <div className="w-48 shrink-0 space-y-1">
            ...
            <select
              value={reportOption}
              onChange={(e) => setReportOption(Number(e.target.value))}
