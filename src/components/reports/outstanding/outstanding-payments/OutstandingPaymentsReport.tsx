              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="flex gap-6">
                    ...
                    <span className="text-xs font-bold text-rose-600 dark:text-rose-400">Pending: {H.formatNumber(H.getLedgerPending(item.data, precision), precision)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="sticky bottom-0 z-10 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-[0_-4px_12px_-2px_rgba(0,0,0,0.05)] p-4">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-8">
                ...
                <div className="text-right">
                  <span className="text-[10px] text-rose-500 font-bold uppercase tracking-wider block mb-1">Pending Amount</span>
                  <span className="text-lg font-black text-rose-600 dark:text-rose-400">{H.formatNumber(pendingAmount, precision)}</span>
                </div>
              </div>
            </div>
          </div>
